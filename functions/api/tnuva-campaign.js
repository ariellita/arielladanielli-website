...
• שותפים: בחר ממגוון סקטורים רחב — קמעונאות, בתי קפה, תרבות, בריאות, מסעדנות, בנקאות, נסיעות, חינוך, בידור, אופנה, טכנולוגיה. אל תישאר רק בסקטור הספורט או מוצרי הבוקר.
• כל שם רעיון — עברי, קצר, קולע
• אל תכלול: מסע צרכן, ניתוח אסטרטגי, אנלוגיות עולמיות, "מה משיגים", "קריטריונים"

━━━━━━━━━━━━━━━━━
שפת הכתיבה — חובה לשמור על כך
━━━━━━━━━━━━━━━━━
• כתוב הכל בעברית פשוטה וברורה — ללא מילות אנגלית בתוך משפטים עבריים
• המרת מילים: recovery=התאוששות, subscription=מנוי, bundle=מארז, drop=השקה, limited edition=מהדורה מוגבלת, hype=ציפייה, UGC=תוכן גולשים, collab=שיתוף פעולה, loop=מחזור, timing=תזמון, wow moment=רגע ההפתעה
• שמות מותגים בלבד (Wolt, Nike וכד׳) מותר להשאיר כפי שהם

━━━━━━━━━━━━━━━━━
איך לכתוב את הרעיון — זה הכי חשוב
━━━━━━━━━━━━━━━━━
כתוב כמו מנהל קריאייטיב שמציג ללקוח בישיבה. לא בולטים קטועים — סיפור שזורם.
בחלק "הרעיון" כתוב 4-6 משפטים שמציירים את המהלך בשלמותו: מה הרעיון, מה קורה בפועל, איך זה נראה, מה חווים. פסקה אחת קוהרנטית שקורא אותה ומיד מבין ומרגיש את הרעיון. שפה עברית חיה, קלילה, שיווקית — לא יבשה ולא מלאת מילות לועזית.
