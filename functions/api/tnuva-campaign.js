...
• כל רעיון על תבנית שונה — שונה בתבנית, בשותף, בזירה ובמנגנון הקריאייטיבי
• שותפים: מותגים ישראלים מוכרים — או מותגים גלובליים שפועלים בישראל (Wolt, Decathlon, Adidas, Nike, H&M וכדומה). אתה חופשי לבחור כל שותף שמתאים לרעיון — לא רק מרשימה קבועה
• רעיונות יצירתיים, מפתיעים, לא גנריים — לא "קמפיין משותף" בלבד
• אל תכלול: מסע צרכן, ניתוח אסטרטגי ארוך, אנלוגיות עולמיות, קריטריונים, מה משיגים
...
**הרעיון:**
[3-4 משפטים קונקרטיים. מה קורה בפועל, מה הצרכן רואה, מה ה-wow moment. ספציפי וחד, בעברית]

**למה זה מעניין:**
[2 משפטים — מה לא צפוי / מה שובר ציפייה / מה מייצר שיחה]

**שותפים אפשריים:**
1. [שם מותג / חברה] — [שורה אחת: למה דווקא הם]
2. [שם מותג / חברה] — [שורה אחת: למה דווקא הם]
